...
import 'package:delivery_app/services/order_services.dart';
            ...
            ListTile(
              ...
              trailing: Column(
                ...
                children: [
                  ...
                  Text(
                    'Amount : \Rs. ${widget.document.data()['total'].toStringAsFixed(0)}',
                    style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                      ...
                      subtitle: Text(
                        '${widget.document.data()['products'][index]['qty']} x \Rs. ${widget.document.data()['products'][index]['price'].toStringAsFixed(0)} = \Rs. ${widget.document.data()['products'][index]['total'].toStringAsFixed(0)}',
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '\Rs. ${widget.document.data()['discount']}',
                                        style: TextStyle(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '\Rs. ${widget.document.data()['discountCode']}',
                                        style: TextStyle(
                                            color: Colors.grey, fontSize: 12),
                                      ),
                                    ],
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '\Rs. ${widget.document.data()['deliveryFee']}',
                                      style: TextStyle(
                                          color: Colors.grey, fontSize: 12),
                                    ),
                                  ],
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '\Rs. ${widget.document.data()['servicecharge']}',
                                      style: TextStyle(
                                          color: Colors.grey, fontSize: 12),
                                    ),
                                  ],
